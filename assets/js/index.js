...
const genreList = {
  // genre string from genre_id ge 23 for action
...
const heroBanner = function ({ results: movieList }) {
  ...
  //   fetch top rated movies upcoming and trending
...
const addHeroSlide = function () {
  ...
  const sliderStart = function () {
    ...
    lastSliderItem = sliderItems[Number(this.getAttribute('slider-controls'))];
